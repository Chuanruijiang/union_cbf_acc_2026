...
class CbfConstraint:
    ...
    def __init__(
        ...
        Lf_r_1_h = lie_derivative(poly=h, vector_feild=f, variables=x, pow = relative_degree-1)
        Lf_r_1_Lgh = lie_derivative(poly=Lf_r_1_h, vector_feild=g, variables=x, pow = 1)
        self.lhs_coeff = Lf_r_1_Lgh
